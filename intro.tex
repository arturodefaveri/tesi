...
\end{align}
\footnotetext{We can distinguish each vertex: we are not considering isomorphism classes for now.}
...
We shall see that all of what we have been saying applies also to more complex structures than graphs, provided that we consider \emph{relational} and not algebraic structures. %\footnote{groups}.
